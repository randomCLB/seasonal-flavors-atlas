...
2026-09-25 核对。站内仅使用本地文件；表中“原始尺寸”取自 Wikimedia Commons 文件信息，“站内尺寸”取实际文件。照片中的异地产区已在详情图注说明。鸡头米详情另有一张明确标注的生成示意图；首页所用芡实植株图仍是真实照片。下方另列出暂时公开展示、但来源或许可尚未核清的照片。
...
以下照片按用户要求暂用于公开页面，不能当成开放授权素材。保留原图水印；仍需确认转载许可。南湖菱照片已经核对嘉兴产地及典型圆钝外形，其余候选未逐张核实摄影者、拍摄地和地方品种，页面以“形态参考”标识，不作为采食鉴别依据。

| 用途 | 文件与站内尺寸 | 已知来源、处理及待办 |
| --- | --- | --- |
...
| 如皋黑塌菜形态参考 | `dist/assets/takecai-candidate.jpg` 640×426 | 同上 |
| 洪湖藕带形态参考 | `dist/assets/oudai-candidate.jpg` 2500×2500 | 同上 |
| 猴腿菜形态参考 | `dist/assets/houtui-candidate.jpeg` 2000×1500 | 同上；物种尚未核实，不作为采食鉴别依据 |
| 璧山儿菜形态参考 | `dist/assets/ercai-candidate.jpeg` 1351×1013 | 同上 |
| 菊花脑形态参考 | `dist/assets/juhuanao-candidate.jpg` 1080×720 | 同上 |
| 淮安蒲菜形态参考 | `dist/assets/pucai-candidate.jpg` 707×1200 | 同上 |

## 尚缺原料实拍

目前 24 味均已配置页面主图，可浏览所有条目。部分照片是同类或候选形态参考，不能据此确认地方品种；南湖菱新闻照片转载许可仍待确认。枞菌与刺竹笋已补充许可明确的图片，但展示的是松乳菇常见种和近似竹笋，并非湘西或腾冲的产地实拍。

| 食材 | 要找的画面 | 核验重点 |
| --- | --- | --- |
| 南湖菱 | 新华社嘉兴采收图和新闻详情图可见；补充当地许可明确的摄影作品 | 新闻摄影转载许可仍待确认 |
| 鸡头米 | 现有鲜粒示意图和芡实植株图 | 后续可补苏州鲜剥粒实拍 |
| 宝应慈姑 | 已有普通慈姑参考图 | 后续补宝应老乌品种实拍 |
| 增城迟菜心 | 已有候选菜心照片 | 后续核验品种、来源与拍摄地 |
| 淮安蒲菜 | 已有候选蒲菜照片 | 后续核验香蒲嫩芯身份与拍摄地 |
| 菊花脑 | 已有候选嫩叶照片 | 后续核验食用种类与拍摄地 |
| 洪湖藕带 | 已有候选原料照和开放许可成菜照 | 后续补洪湖原料产地实拍 |
| 猴腿菜 | 已有候选蕨茎照片 | 物种与来源仍需确认，不作采食鉴别 |
| 刺竹笋 | 已有开放许可竹笋形态参考 | 后续补腾冲刺竹品种实拍 |
| 阳新湖蒿 | 已有蒌蒿形态参考 | 后续确认阳新地方品系 |
| 璧山儿菜 | 已有候选儿菜照片 | 后续核验地方品种与拍摄地 |
| 枞菌 | 已有开放许可松乳菇实拍 | 后续核验湘西当地“枞菌”所指物种并补产地实拍 |
| 如皋黑塌菜 | 已有塌棵菜同类参考图 | 后续核验如皋地方品种 |
