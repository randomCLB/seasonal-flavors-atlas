...
产季以具体产地为准；节气首页按对应月份呈现食材，地图可看单月或全年，不保证每年每地同时上市。详情页末尾列出资料出处。24 味食材的文字已扩写为约 600—900 字，并提供两人份做法。图片授权与逐味缺口见 [图片清单](IMAGE_REGISTER.md)；候选扩充见 [第 25—48 味矩阵](CANDIDATES_25_48.md)。尚缺 15 味匹配的原料主图，不能把它们标记为图片验收完成。没有可靠授权或无法确认食材身份的图片不用于词条。
